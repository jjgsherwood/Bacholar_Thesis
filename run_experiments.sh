...
MPLBACKEND=agg python main.py --k 6 --l 3 --hidden_ch 16 --warmup_steps 1000 --init_lr 0.001 --batch_size 64 --epochs 100 --cuda True --log_step 10 --output_dir ./liver_experiment2 --dataset liver --structure liver --data_dir ../data/HSI/Liver_map_150z25_60s_1TCPOBOP.npy
...
# load model
MPLBACKEND=agg python load_model.py --output_dir ./liver_experiment
