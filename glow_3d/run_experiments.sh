...
MPLBACKEND=agg python main.py --k 10 --l 3 --hidden_ch 32 --warmup_steps 500 --init_lr 0.001 --batch_size 64 --epochs 100 --cuda True --log_step 10 --output_dir ./liver_experiment1 --dataset liver --structure liver_extended --data_dir ../data/HSI/Liver_map_150z25_60s_1TCPOBOP.npy
